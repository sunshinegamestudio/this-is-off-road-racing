 ...
 */
public class BeachHouse extends Entity_AppState implements CleanupManualInterface {
    ...
    public BeachHouse(String track, AssetManager assetManager, Node parent, PhysicsSpace physicsSpace) {
