...
import gui.nifty.systems.MainMenuState;
import gui.nifty.systems.LicenseViewMenuState;
import gui.nifty.systems.ControllerSelectorState;
import cargame.appstates.TrackSelectorState;
import gui.nifty.systems.InGameMenuState;
import cargame.appstates.GameState;
import gui.nifty.systems.LicenseAcceptanceState;
...
public class CarGame extends SimpleApplication {
    ...
    public static void main(String[] args) {
        ...
        settings.setSettingsDialogImage("General/Textures/Interface/logo.png");
